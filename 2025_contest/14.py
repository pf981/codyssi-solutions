...
for line in lines:
    code, quality, cost, unique_materials = re.match(
        ...
        # "1 iqmgqtz | Quality : 24, Cost : 16, Unique Materials : 14",
        line
    ).groups()
...
def get_max_quality(i, units):
    ...
    return max(
        (discard_quality, discard_mats), 
        (keep_quality, keep_mats)
    )

answer2 = get_max_quality(0, 30)
print(answer2[0] * answer2[1])
# 7560 incorrect

# Part 3
answer3 = get_max_quality(0, 300)
